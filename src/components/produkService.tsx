...
export default function CardService({ className }: { className?: string }) {
  return (
        ...
        <div className="flex flex-col md:flex-row justify-evenly gap-6">
            ...
            <div className=" card w-52  bg-gradient-to-b from-teal-950 to-slate-900 border border-slate-50 shadow-xl ">
              <div className="card-body ">
                ...
                <div className="card-actions justify-start">
                  <Link href="/form">
                    <button className="btn bg-slate-200 hover:bg-slate-400 text-slate-900 lg:mt-10">Start Now</button>
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className=" card w-52 bg-gradient-to-b from-teal-950 to-slate-900 border border-slate-50 shadow-xl ">
            <div className="card-body ">
              ...
              <div className="card-actions justify-start">
                <Link href="/form">
                  <button className="btn bg-slate-200 hover:bg-slate-400 text-slate-900 mt-10">Start Now</button>
                </Link>
              </div>
            </div>
          </div>
          <div className="card w-52 bg-gradient-to-b from-teal-950 to-slate-900 border border-slate-50 shadow-xl">
            <div className="card-body ">
              ...
              <div className="card-actions justify-start">
                <Link href="/form">
                  <button className="btn bg-slate-200 hover:bg-slate-400 text-slate-900 mt-3">Start Now</button>
                </Link>
              </div>
            </div>
          </div>
