      ...
      <div className="flex flex-col sm:flex-row flex-wrap py-3 gap-3 px-8 justify-center items-center">
        <div className="w-full max-w-sm bg-gradient-to-b from-teal-950  to-transparent border border-slate-50 rounded-lg shadow">
          <div className="flex flex-col items-center justify-center py-10">
            <Image priority className="w-24 h-24 mb-3 rounded-full shadow-lg border border-slate-50" width={50} height={50} src="/profile4.jpg" alt="Bonnie image" />
        ...
        <div className="w-full max-w-sm bg-gradient-to-b from-teal-950  to-transparent border border-slate-50 rounded-lg shadow">
          <div className="flex flex-col items-center justify-center py-10">
            <Image priority className="w-24 h-24 mb-3 rounded-full shadow-lg border border-slate-50" width={50} height={50} src="/profile2.jpg" alt="Bonnie image" />
        ...
        <div className="w-full max-w-sm bg-gradient-to-b from-teal-950 to-transparent border border-slate-50 rounded-lg shadow">
          <div className="flex flex-col items-center justify-center py-10">
            <Image priority className="w-24 h-24 mb-3 rounded-full shadow-lg border border-slate-50" width={50} height={50} src="/testi1.jpg" alt="Bonnie image" />
        ...
        <div className="w-full max-w-sm bg-gradient-to-b from-teal-950 to-transparent border border-slate-50 rounded-lg shadow">
          <div className="flex flex-col items-center justify-center py-10">
            <Image priority className="w-24 h-24 mb-3 rounded-full shadow-lg border border-slate-50" width={50} height={50} src="/profile.jpg" alt="Bonnie image" />
        ...
        <div className="w-full max-w-sm bg-gradient-to-b from-teal-950 to-transparent border border-slate-50 rounded-lg shadow">
          <div className="flex flex-col items-center justify-center py-10">
            <Image priority className="w-24 h-24 mb-3 rounded-full shadow-lg border border-slate-50" width={50} height={50} src="/profile1.jpg" alt="Bonnie image" />
