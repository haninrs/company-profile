    ...
    <div className="">
      <div className="hero min-h-96" style={{ background: "linear-gradient(to bottom, transparent, #0f172a), url(/hero4.jpg)", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="hero-content text-center px-6 text-slate-50">
          <div className="max-w-md ">
            <h1 className="mb-5 text-3xl sm:text-5xl font-bold">LEADING GAME DEVELOPMENT COMPANY</h1>
          </div>
        </div>
      </div>
      <div className="bg-gradient-to-t from-slate-900 via-teal-950 to-slate-900 ">
        <div className=" text-slate-50 ">
          <div>
            <section className="px-14 pt-10 pb-7 text-center">
              <h1 className="text-2xl sm:text-3xl font-semibold pb-5">WHO WE ARE</h1>
            ...
            <hr />
            <h1 className="text-xl sm:text-2xl font-semibold py-7 text-center">COMPANY OVERVIEW</h1>
            <hr />
            <TimelineSec />
            <hr />
            <h1 className="text-xl sm:text-2xl font-semibold py-7 text-center">OUR TEAM</h1>
            <hr />
            <TeamAbout />
            <hr />
            <h1 className="text-xl sm:text-2xl font-semibold py-7 text-center">CULTURE AT GAMESTART</h1>
            <hr />
            <CultureSec />
          </div>
        </div>
